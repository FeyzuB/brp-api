create or replace package body brp_api_bewoning is
  gc_package constant varchar2(100) := 'brp_api_bewoning.';
  gc_log_einde constant varchar2(30) := 'EINDE';

  gc_path constant varchar2(200) := '/bewoningen'; -- Endpoint for Bewoning
  ...
  procedure lees_bewoning(
    ...
    lv_scope logger_logs.scope%type := gc_package || 'lees_bewoning';
