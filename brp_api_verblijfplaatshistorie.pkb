create or replace package body brp_api_verblijfplaatshistorie is
  gc_package constant varchar2(100) := 'brp_api_verblijfplaatshistorie.';
  gc_log_einde constant varchar2(30) := 'EINDE';

  gc_path constant varchar2(200) := '/verblijfplaatshistorie'; -- Endpoint for Verblijfplaatshistorie
